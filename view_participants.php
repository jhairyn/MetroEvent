...
$requests_query = "SELECT r.id, u.name as user_name, e.title as event_name 
                   ...
                   WHERE e.organizer_id = '$organizer_id' AND r.status = 'accepted'";
...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100 bg-light">
            ...
            <section class="py-5">
                <div class="container px-5 mb-5">
                    <div class="text-center mb-5">
                        <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">Approved Participants</span></h1>
                    </div>
        ...
        <?php else: ?>
            <p>No approved participants at the moment.</p>
        <?php endif; ?>
